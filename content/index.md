...
#### Table of Contents
- [1. Ba thành phần của ngành phát triển ứng dụng - Web application development fundamentals consist of 3 building blocks :](#1-ba-thành-phần-của-ngành-phát-triển-ứng-dụng---web-application-development-fundamentals-consist-of-3-building-blocks-)
  - [1.1. HTML: Hypertext Mark-up Language: ngôn ngữ HTML để viết trang web](#11-html-hypertext-mark-up-language-ngôn-ngữ-html-để-viết-trang-web)
  - [1.2. Cascading Style Sheets (CSS):](#12-cascading-style-sheets-css)
  - [1.3. Javascript / Typescript:](#13-javascript--typescript)
    - [1.3.1 Javascript: là gì:](#131-javascript-là-gì)
    - [1.3.2 Typescript là gì](#132-typescript-là-gì)
  - [1.4 Các thư viện để viết ứng dụng web (web app) - frameworks and libraries to build web app:](#14-các-thư-viện-để-viết-ứng-dụng-web-web-app---frameworks-and-libraries-to-build-web-app)

- [2. Data types - Các kiểu dữ liệu:](#2-data-types---các-kiểu-dữ-liệu)
  - [2.1 PRIMITIVE DATA TYPES: các kiểu dữ liệu đơn, thuần tuý](#21-primitive-data-types-các-kiểu-dữ-liệu-đơn-thuần-tuý)
    - [2.1.1 Kiểu chuỗi: string](#211-kiểu-chuỗi-string)
    - [2.1.2 Kiểu số: number](#212-kiểu-số-number)
    - [2.1.3 Kiểu mệnh đề Đúng/Sai : Boolean](#213-kiểu-mệnh-đề-đúngsai--boolean)
  - [2.2 NON-PRIMITIVE DATA TYPES: các kiểu dữ liệu phức hợp (không thuần tuý):](#22-non-primitive-data-types-các-kiểu-dữ-liệu-phức-hợp-không-thuần-tuỳ)
    - [2.2.1 Kiểu mảng - Array:](#221-kiểu-mảng---array)
    - [2.2.2 Kiểu đối tượng hay còn gọi dễ hiểu là kiểu phức hợp:](#222-kiểu-đối-tượng-hay-còn-gọi-dễ-hiểu-là-kiểu-phức-hợp)
- [3. Basic looping methods in Javascript : Các vòng lặp phổ biến trong lập trình](#3-basic-looping-methods-in-javascript--các-vòng-lặp-phổ-biến-trong-lập-trình)
- [4. Javascript native methods - Các hàm tự nhiên trong Javascript](#4-javascript-native-methods---các-hàm-tự-nhiên-trong-javascript)
  - [4.1 String prototype & functions: Kiểu mẫu String và các hàm thao tác chuỗi ký tự](#41-string-prototype--functions-kiểu-mẫu-string-và-các-hàm-thao-tác-chuỗi-ký-tự)
  - [4.2 Array prototype functions: Kiểu mẫu Array - mảng và các hàm xử lý mảng](#42-array-prototype-functions-kiểu-mẫu-array---mảng-và-các-hàm-xử-lý-mảng)
  - [4.3 Object prototype functions: Các hàm thao tác với dự liệu kiểu Object trong Javascript](#43-object-prototype-functions-các-hàm-thao-tác-với-dự-liệu-kiểu-object-trong-javascript)
    - [Referencing the property value of an object: **Cách gọi thuộc tính**](#referencing-the-property-value-of-an-object-cách-gọi-thuộc-tính)
    - [Assign new property for the studentObject: gán thuộc tính (property) mới vào trong studentObject:](#assign-new-property-for-the-studentobject-gán-thuộc-tính-property-mới-vào-trong-studentobject)
    - [Xoá thuộc tính khỏi studentObject:](#xoá-thuộc-tính-khỏi-studentobject)
- [5. Event handler & Event listener in Javascript - Event handler & & Event listener trong Javascript](#5-event-handler--event-listener-in-javascript---event-handler--event-listener-trong-javascript)
  - [5.1 Event handler: (hàm xử lý sự kiện)](#51-event-handler-hàm-xử-lý-sự-kiện)
  - [5.2 Event Listener](#52-event-listener)
- [6. Javascript ES6 (version 2015) features](#6-javascript-es6-version-2015-features)
  - [Khái quát về Vue:](#khái-quát-về-vue)
- [7. VUE framework: Chương trình khung / thư viện Vue để làm ứng dụng web interface và các chức năng web](#7-vue-framework-chương-trình-khung--thư-viện-vue-để-làm-ứng-dụng-web-interface-và-các-chức-năng-web)


- [Ba thành phần của ngành phát triển ứng dụng - Web application development fundamentals consist of 3 building blocks :](#ba-thành-phần-của-ngành-phát-triển-ứng-dụng---web-application-development-fundamentals-consist-of-3-building-blocks-)
  - [HTML: Hypertext Mark-up Language: ngôn ngữ HTML để viết trang web](#html-hypertext-mark-up-language-ngôn-ngữ-html-để-viết-trang-web)
  - [Cascading Style Sheets (CSS):](#cascading-style-sheets-css)
  - [Javascript / Typescript:](#javascript--typescript)
    - [Javascript: là gì:](#javascript-là-gì)
    - [Typescript là gì](#typescript-là-gì)
  - [Các thư viện để viết ứng dụng web (web app) - frameworks and libraries to build web app:](#các-thư-viện-để-viết-ứng-dụng-web-web-app---frameworks-and-libraries-to-build-web-app)
- [Data types - Các kiểu dữ liệu:](#data-types---các-kiểu-dữ-liệu)
  - [PRIMITIVE DATA TYPES: các kiểu dữ liệu đơn, thuần tuý](#primitive-data-types-các-kiểu-dữ-liệu-đơn-thuần-tuý)
    - [Kiểu chuỗi: string](#kiểu-chuỗi-string)
    - [Kiểu số: number](#kiểu-số-number)
    - [Kiểu mệnh đề Đúng/Sai : Boolean](#kiểu-mệnh-đề-đúngsai--boolean)
  - [NON-PRIMITIVE DATA TYPES: các kiểu dữ liệu phức hợp (không thuần tuý):](#non-primitive-data-types-các-kiểu-dữ-liệu-phức-hợp-không-thuần-tuỳ)
    - [Kiểu mảng - Array:](#kiểu-mảng---array)
    - [Kiểu đối tượng hay còn gọi dễ hiểu là kiểu phức hợp:](#kiểu-đối-tượng-hay-còn-gọi-dễ-hiểu-là-kiểu-phức-hợp)
- [Basic looping methods in Javascript : Các vòng lặp phổ biến trong lập trình](#basic-looping-methods-in-javascript--các-vòng-lặp-phổ-biến-trong-lập-trình)
- [Javascript native methods - Các hàm tự nhiên trong Javascript](#javascript-native-methods---các-hàm-tự-nhiên-trong-javascript)
  - [String prototype & functions: Kiểu mẫu String và các hàm thao tác chuỗi ký tự](#string-prototype--functions-kiểu-mẫu-string-và-các-hàm-thao-tác-chuỗi-ký-tự)
  - [Array prototype functions: Kiểu mẫu Array - mảng và các hàm xử lý mảng](#array-prototype-functions-kiểu-mẫu-array---mảng-và-các-hàm-xử-lý-mảng)
  - [Object prototype functions: Các hàm thao tác với dự liệu kiểu Object trong Javascript](#object-prototype-functions-các-hàm-thao-tác-với-dự-liệu-kiểu-object-trong-javascript)
    - [Referencing the property value of an object: **Cách gọi thuộc tính**](#referencing-the-property-value-of-an-object-cách-gọi-thuộc-tính)
    - [Assign new property for the studentObject: gán thuộc tính (property) mới vào trong studentObject:](#assign-new-property-for-the-studentobject-gán-thuộc-tính-property-mới-vào-trong-studentobject)
    - [Xoá thuộc tính khỏi studentObject:](#xoá-thuộc-tính-khỏi-studentobject)
- [Event handler & Event listener in Javascript - Event handler & & Event listener trong Javascript](#event-handler--event-listener-in-javascript---event-handler--event-listener-trong-javascript)
  - [Event handler: (hàm xử lý sự kiện)](#event-handler-hàm-xử-lý-sự-kiện)
  - [Event Listener](#event-listener)
- [Javascript ES6 (version 2015) features](#javascript-es6-version-2015-features)
  - [Khái quát về Vue:](#khái-quát-về-vue)
- [VUE framework: Chương trình khung / thư viện Vue để làm ứng dụng web interface và các chức năng web](#vue-framework-chương-trình-khung--thư-viện-vue-để-làm-ứng-dụng-web-interface-và-các-chức-năng-web)

## Ba thành phần của ngành phát triển ứng dụng - Web application development fundamentals consist of 3 building blocks :
...
A very computer science-y answer for `data`{style="color: green"} would be: things like `"strings"`{style="color: green"}, `integers (42)`{style="color: green"}, `objects ({ pizza: true })`{style="color: green"}, etc.
  ...
  ### HTML: Hypertext Mark-up Language: ngôn ngữ HTML để viết trang web
...
https://fptshop.com.vn/tin-tuc/danh-gia/typescript-168823
  ...
  ### Các thư viện để viết ứng dụng web (web app) - frameworks and libraries to build web app:
...
Khai báo array/object có thể dùng `let`{style="color: green"} / `const`{style="color: green"} tuỳ thích, nhưng thường dùng `const`{style="color: green"} để tránh việc thay đổi giá trị của biến array/object
  ...
  ### PRIMITIVE DATA TYPES: các kiểu dữ liệu đơn, thuần tuý
...
Khai báo biến tren18tuoi với giá trị true - đúng, và biến coBangLai với giá trị false - sai
  ...
  ### NON-PRIMITIVE DATA TYPES: các kiểu dữ liệu phức hợp (không thuần tuý):
...
```
    #### Kiểu đối tượng hay còn gọi dễ hiểu là kiểu phức hợp:
...
## Basic looping methods in Javascript : Các vòng lặp phổ biến trong lập trình
...
## Javascript native methods - Các hàm tự nhiên trong Javascript
...
### Array prototype functions: Kiểu mẫu Array - mảng và các hàm xử lý mảng
...
### Object prototype functions: Các hàm thao tác với dự liệu kiểu Object trong Javascript
...
```
    ...
    #### Referencing the property value of an object: **Cách gọi thuộc tính**
```js
...
car.color // White
```
    #### Assign new property for the studentObject: gán thuộc tính (property) mới vào trong studentObject:
...
`studentObject.key = 'value'`{language="js"}   -> thuộc tính (property) và giá trị của thuộc tính (property value) còn được hiểu là 1 cặp key-value pair (pair tiếng Anh là 1 cặp, ví dụ: a pair of shoes, a pair of jeans)
    ...
    #### Xoá thuộc tính khỏi studentObject:
...
## Event handler & Event listener in Javascript - Event handler & & Event listener trong Javascript
...
...
## Javascript ES6 (version 2015) features
...
## VUE framework: Chương trình khung / thư viện Vue để làm ứng dụng web interface và các chức năng web
...
### Web chính thức Official của VUE3:
...
### Vue Learning experience: Những kinh nghiệm đúc kết trong quá trình học & dợt Vue 1 tuần qua:
